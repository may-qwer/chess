...
void Board::show() {
    ...
    //     cout << endl;
    // }
    cout << BLACK << " 1 " << RESET << endl;
    cout << WHITE << " 1 " << RESET << endl;
    cout << BACKGROUND_BLACK << BLACK << " 1 " << RESET << endl;
    cout << BACKGROUND_WHITE << WHITE << " 1 " << RESET << endl;
}
...
void Board::set_start_pos(char *pos_str) { 
    ...
    for (int i = 0; i < COUNT_OF_FIGURES_SIMBOLS; i += 2) {
        ...
        board_mtx[num_pos-1][litter_pos-1] = '1';
    }
}
